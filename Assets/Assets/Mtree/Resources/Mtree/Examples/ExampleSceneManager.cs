...
public class ExampleSceneManager : MonoBehaviour
{
    ...
    Material Floor;
    GameObject SceneObject,Trees,PostProcessing;
    bool Setup = true;
    ...
    if( Utils.GetCurrentPipeline() == "legacy"){
        ...
        var cam = SceneObject.GetComponentInChildren<Camera>().gameObject;
        cam.layer = 1;
    ...
    void LegacySetup(){
        ...
        SceneObject = Instantiate(Resources.Load("Mtree/Examples/Legacy") as GameObject,this.transform);
        Debug.Log("Legacy Scene loaded!");
#else
        SceneObject = Instantiate(Resources.Load("Mtree/Examples/Legacy 2018_3_OR_OLDER") as GameObject,this.transform);
    ...
    void LWRPSetup()
    {
        ...
        SceneObject = Instantiate(Resources.Load("Mtree/Examples/LWRP") as GameObject,this.transform);
    ...
    #if UNITY_2019_3_OR_NEWER
        SceneObject = Instantiate(Resources.Load("Mtree/Examples/HDRP 2019_3_OR_NEWER") as GameObject,this.transform);
        Debug.Log("HDRP 2019.3+ Scene loaded!");
    #else
        SceneObject = Instantiate(Resources.Load("Mtree/Examples/HDRP") as GameObject,this.transform);
    ...
    {
        #if UNITY_2019_3_OR_NEWER
            SceneObject = Instantiate(Resources.Load("Mtree/Examples/URP") as GameObject,this.transform);
