...
public class VRController : MonoBehaviour
{
    ...
    {
        //Figure out movment orientation
        ...
        movment += orientation * (m_Speed * Vector3.forward);
        movment.y -= m_Gravity * Time.deltaTime;



        //Apply
        m_CharacterController.Move(movment * Time.deltaTime);
