...
Shader "Mtree/Leaves"
{
	...
	SubShader
	{
		...
		float3 switch254_g313( int Enum , float3 zero , float3 one , float3 two , float3 three )
		{
			float3 output;
			if(Enum == 0){
				output = zero;}
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			int Enum254_g313 = _WindMode;
			float3 ase_vertex3Pos = v.vertex.xyz;
			float3 vertexPosition255_g313 = mul( unity_ObjectToWorld, float4( ase_vertex3Pos , 0.0 ) ).xyz;
			float3 break261_g313 = vertexPosition255_g313;
			float2 appendResult196_g313 = (float2(break261_g313.x , break261_g313.z));
			float MainWind71_g313 = ( _WindStrength * _GlobalWindInfluence );
			float4 transform21_g314 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			float2 appendResult22_g314 = (float2(transform21_g314.x , transform21_g314.z));
			float dotResult2_g314 = dot( ( appendResult22_g314 + float2( 0,0 ) ) , float2( 12.9898,78.233 ) );
			float lerpResult8_g314 = lerp( 0.8 , ( ( _RandomWindOffset / 2.0 ) + 0.9 ) , frac( ( sin( dotResult2_g314 ) * 43758.55 ) ));
			float RandomTime45_g313 = ( _Time.x * lerpResult8_g314 );
			float Turbulence58_g313 = ( sin( ( ( RandomTime45_g313 * 40.0 ) - ( (vertexPosition255_g313).z / 15.0 ) ) ) * 0.5 );
			float Angle89_g313 = ( MainWind71_g313 * ( 1.0 + sin( ( ( ( RandomTime45_g313 * 2.0 ) + Turbulence58_g313 ) - ( ( vertexPosition255_g313.z / 50.0 ) - ( v.color.r / 20.0 ) ) ) ) ) * sqrt( v.color.r ) * 0.02 * _WindPulse );
			float sin_a100_g313 = sin( Angle89_g313 );
			float cos_a119_g313 = cos( Angle89_g313 );
			float temp_output_99_0_g313 = radians( _WindDirection );
			float2 appendResult200_g313 = (float2(cos( temp_output_99_0_g313 ) , sin( temp_output_99_0_g313 )));
			float2 xzLerp129_g313 = ( ( appendResult200_g313 + 1 ) / 2 );
			float2 lerpResult140_g313 = lerp( appendResult196_g313 , ( ( appendResult196_g313 + ( break261_g313.y * sin_a100_g313 ) ) * cos_a119_g313 ) , (xzLerp129_g313).yx);
			float2 break204_g313 = lerpResult140_g313;
			float3 appendResult174_g313 = (float3(break204_g313.x , ( ( break261_g313.y * cos_a119_g313 ) - ( break261_g313.z * sin_a100_g313 ) ) , break204_g313.y));
			float3 v_pos175_g313 = appendResult174_g313;
			float3 zero254_g313 = v_pos175_g313;
			float3 break188_g313 = v_pos175_g313;
			float WindTurbulence110_g313 = ( _WindTurbulence * _GlobalTurbulenceInfluence );
			float leaf_turbulence135_g313 = ( sin( ( ( ( RandomTime45_g313 * 200.0 ) * ( v.color.g + 0.2 ) ) + ( v.color.g * 10.0 ) + Turbulence58_g313 + ( vertexPosition255_g313.z / 2.0 ) ) ) * v.color.b * ( ( MainWind71_g313 / 200.0 ) + Angle89_g313 ) * WindTurbulence110_g313 );
			float3 appendResult153_g313 = (float3(break188_g313.x , ( break188_g313.y + leaf_turbulence135_g313 ) , break188_g313.z));
			float3 one254_g313 = appendResult153_g313;
			float3 ase_worldNormal = UnityObjectToWorldNormal( v.normal );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float3 appendResult184_g313 = (float3(( ase_normWorldNormal.x * v.color.g ) , ( ase_normWorldNormal.y / v.color.r ) , ( ase_normWorldNormal.z * v.color.g )));
			float3 two254_g313 = ( ( appendResult184_g313 * leaf_turbulence135_g313 ) + v_pos175_g313 );
			float3 break247_g313 = v_pos175_g313;
			float2 break241_g313 = xzLerp129_g313;
			float lerpResult238_g313 = lerp( 0.0 , leaf_turbulence135_g313 , break241_g313.x);
			float lerpResult242_g313 = lerp( 0.0 , leaf_turbulence135_g313 , break241_g313.y);
			float3 appendResult249_g313 = (float3(( break247_g313.x + lerpResult238_g313 ) , break247_g313.y , ( break247_g313.z + lerpResult242_g313 )));
			float3 three254_g313 = appendResult249_g313;
			float3 localswitch254_g313 = switch254_g313( Enum254_g313 , zero254_g313 , one254_g313 , two254_g313 , three254_g313 );
			v.vertex.xyz = mul( unity_WorldToObject, float4( localswitch254_g313 , 0.0 ) ).xyz;
		}
...
/*ASEBEGIN
Version=17300
431;337;1264;592;885.4692;-1007.596;1;True;False
...
Node;AmplifyShaderEditor.IntNode;74;-1493.075,477.5758;Inherit;False;Property;_WindMode;Wind Mode;23;1;[Enum];Create;True;4;Default;0;Leaf;1;Palm;2;Grass;3;0;False;1;Header(Wind);0;2;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;250;-1218.598,516.7045;Inherit;False;Mtree Wind Node;-1;;313;64b78a30028980947ab723bea7191537;0;3;235;INT;0;False;167;FLOAT;0;False;166;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=648C14B3CBF5320A476D080117F14ACC8D0C9DED