...
namespace Mtree
{
    public class Utils
    {
        ...
        public static Shader GetLeafShader()
        {
            ...
            switch(GetCurrentPipeline()){
                case "legacy":
                    shader = Shader.Find("Mtree/Leaves");
                break;

                case "lwrp":
                    shader = Shader.Find("Mtree/SRP/Leaves LWRP");
                break;

                case "hdrp":
                    shader = Shader.Find("Mtree/SRP/Leaves HDRP");
                break;

                case "urp":
                    shader = Shader.Find("Mtree/SRP/Leaves URP");
                break;
            }
            return shader;
        }
